...
func BeginAdventure() {
	...
	l3 := "Vous voyez le reste de votre ex-vaisseau, toujours accessible. Derrière vous se trouve des trâces de pattes de chat, s'en allant à l'opposé de vous. Vous n'êtes pas seul.\n"
